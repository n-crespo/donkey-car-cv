...
MAX_STEERING_ANGLE = 3.141592653589793 / 3.5  # for car-like robot; maximum steering angle in radians (corresponding to tire angle at steering == -1)
...
CONFIDENCE_THRESHOLD = 0.0005   # The fraction of total sampled pixels that must be yellow in the sample slice.
...
THROTTLE_MAX = 0.60    # maximum throttle value the controller will produce
THROTTLE_MIN = 0.58   # minimum throttle value the controller will produce
